...
const Input = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#1D2226] rounded-lg p-3 space-y-3 border border-gray-300 dark:border-none">
      ...
      <div className="flex items-center flex-wrap gap-y-4 justify-center gap-x-4 md:gap-x-10">
      <button className="inputButton group">
        ...
        <button className="inputButton group">
          <SwapHorizIcon className="text-blue-300" />
          <h4 className="opacity-80 group-hover:opacity-100">Swap</h4>
        </button>
        <button className="inputButton group">
